...
class GameServiceTest {
    ...
    void joinException(){
        try{
            gameService.join("Mr. Monopoly", Piece.RED);
    ...
    void sellBank() {
        ...
        Player p = gameService.getPlayers().get(gameService.getCurrentPlayer());
    ...
    void buyHouse2() {
        ...
        gameService.getPlayers().get(gameService.getCurrentPlayer()).setPossession(37, true);
        field2.setOwner(0);
        field2.setOwned(true);
        gameService.getPlayers().get(gameService.getCurrentPlayer()).setPossession(39, true);
        gameService.buyHouse(39);
        int actual = gameService.getBoard().getFields().get(39).getNumHouses();
        int expected = 1;
        assertEquals(expected, actual);
    ...
    void sellHouse1() {
        ...
        int expected = 1600;
        int actual = gameService.getPlayers().get(gameService.getCurrentPlayer()).getBalance();
    }
